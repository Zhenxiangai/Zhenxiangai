...
<!--START_SECTION:radar_projects-->
  <p align="left">
    ...
    <a href="https://github.com/Tencent/WeKnora">
      <img width="372" alt="WeKnora：把原始文档转成可查询的 RAG、推理 Agent 与自维护 Wiki。" src="./assets/cards/weknora.svg?v=ef441fb7c3" />
    </a>
  ...
  <sub>Star、Fork 与主要语言每 12 小时自动同步；最近同步 2026-09-06（UTC+8）。</sub>
