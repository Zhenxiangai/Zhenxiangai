...
<!--START_SECTION:radar_projects-->
  <p align="left">
    <a href="https://github.com/NousResearch/hermes-agent">
      <img width="372" alt="Hermes Agent：能够持续成长并积累记忆的个人 AI Agent。" src="./assets/cards/hermes-agent.svg?v=806933b829" />
    </a>
    ...
    <a href="https://github.com/Tencent/WeKnora">
      <img width="372" alt="WeKnora：把原始文档转成可查询的 RAG、推理 Agent 与自维护 Wiki。" src="./assets/cards/weknora.svg?v=e0331131d6" />
    </a>
    ...
    <a href="https://github.com/microsoft/markitdown">
      <img width="372" alt="MarkItDown：把 Office、PDF 等文件转换为 Markdown，便于知识摄取与 Agent 工作流。" src="./assets/cards/markitdown.svg?v=da68a41457" />
    </a>
  </p>
